...
public class AnalyticBarrierEngine extends PricingEngine {
  ...
  protected AnalyticBarrierEngine(long cPtr, boolean cMemoryOwn) {
    super(QuantLibJNI.AnalyticBarrierEngine_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public AnalyticBarrierEngine(GeneralizedBlackScholesProcess process) {
    this(QuantLibJNI.new_AnalyticBarrierEngine(GeneralizedBlackScholesProcess.getCPtr(process), process), true);
  }
