...
public class YieldTermStructureHandle {
  ...
  public YieldTermStructure __deref__() {
    return new YieldTermStructure(QuantLibJNI.YieldTermStructureHandle___deref__(swigCPtr, this), true);
  }
  ...
  public Observable asObservable() {
    return new Observable(QuantLibJNI.YieldTermStructureHandle_asObservable(swigCPtr, this), true);
  }
