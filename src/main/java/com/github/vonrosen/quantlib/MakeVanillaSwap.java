...
public class MakeVanillaSwap {
  ...
  public Swap makeVanillaSwap() {
    return new Swap(QuantLibJNI.MakeVanillaSwap_makeVanillaSwap(swigCPtr, this), true);
  }

  public MakeVanillaSwap(Period swapTenor, IborIndex iborIndex, double fixedRate, Period forwardStart) {
    this(QuantLibJNI.new_MakeVanillaSwap(Period.getCPtr(swapTenor), swapTenor, IborIndex.getCPtr(iborIndex), iborIndex, fixedRate, Period.getCPtr(forwardStart), forwardStart), true);
  }
